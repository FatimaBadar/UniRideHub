        ...
        <>
            ...
            <div className="auth-body">
                <div className="auth-side"  style={divStyle}>
                    {isRegister ?
                        <div>
                            ...
                            <TextFade text="Create account to enjoy all the features of carpool" fromDirection="bottom" />
                        </div>
                    : 
                        <div>
                            <TextFade text="Welcome back!" fromDirection="top" />
                            <TextFade text="Sign in to pick up from where you left" fromDirection="bottom" />
                        </div>
                ...
                <div className="auth-card">
                    {
                        isRegister ? <Signup handleRegister={handleRegisterLink} />
